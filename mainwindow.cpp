...
void MainWindow::on_pushButton_clicked()
{
    ...
    if (query.first())
    {
        ...
        if (type == "admin")
        {
            ...
            me->setWindowTitle("Главное меню Администратора");
            me->show();
        }
        else
        {
            if (type == "teacher")
            {
                tutor *me = new tutor(Username, this);
                me->setWindowTitle("Главное меню Преподавателя");
                me->show();
            }
            else
            {
                if (type == "student")
                {
                    ...
                    me->setWindowTitle("Главное меню Пользователя");
                    me->show();
                }
                else
                {
